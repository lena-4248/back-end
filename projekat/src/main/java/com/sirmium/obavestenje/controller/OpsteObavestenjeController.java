...
import com.sirmium.obavestenje.dto.OpsteObavestenjeResponseDTO;
import com.sirmium.obavestenje.model.OpsteObavestenje;
import com.sirmium.obavestenje.service.OpsteObavestenjeService;
...
public class OpsteObavestenjeController {
    ...
    // Get all including inactive - samo admin/službenik
    @GetMapping("/all")
    @PreAuthorize("hasRole('SLUZBENIK') or hasRole('ADMIN')")
    ...
    // Get by author - samo službenik/admin
    ...
    // Get inactive - samo službenik/admin
