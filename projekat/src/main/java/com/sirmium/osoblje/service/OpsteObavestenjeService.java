...
import com.sirmium.osoblje.repository.OpsteObavestenjeRepository;
...
public class OpsteObavestenjeService {
    ...
    private final OpsteObavestenjeRepository repository;

    public OpsteObavestenjeService(OpsteObavestenjeRepository repository) {
    ...
    public List<OpsteObavestenje> findRecent(int days) {
        LocalDate startDate = LocalDate.now().minusDays(days);
        return repository.findRecentActive(startDate);
    }
}